...
<!DOCTYPE html>
  <html lang="en">
    ...
    <title><?php if (!empty($page_title))
           ...
           echo ucfirst($user['name']);
            else echo "POS of Computer Hardware";?>
    </title>
    <link rel="shortcut icon" type="image/png" href="libs/images/favicon.png">
  ...
  <?php  if ($session->isUserLoggedIn(true)): ?>
    <header id="header">
      <div class="logo pull-left" style="font-size: 25px;">INVENTORY</div>
    ...
    <div class="sidebar">
      ...
      <?php elseif($user['user_level'] === '2'): ?>
        <!-- Special user -->
      <?php include_once('assistant.php');?>

      <?php elseif($user['user_level'] === '3'): ?>
        <!-- User menu -->
      <?php include_once('cashier.php');?>
